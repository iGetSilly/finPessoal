    ...
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center p-4">
      <div className="bg-zinc-900 p-8 rounded-2xl border border-zinc-800 shadow-2xl max-w-md w-full">
        ...
        <button
          ...
          disabled={loading}
          className="w-full bg-white hover:bg-gray-100 text-gray-800 font-semibold py-3 rounded-lg transition-all disabled:opacity-50 flex items-center justify-center gap-3 mb-6"
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-zinc-800 text-white p-3 rounded-lg border border-zinc-700 focus:border-emerald-500 outline-none"
              required
            />
          </div>
          ...
          {error && (
            <p className="text-red-400 text-sm bg-red-950 p-3 rounded-lg">
              {error}
            </p>
          )}
